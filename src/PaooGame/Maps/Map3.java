...
import java.io.File;
/// Clasa Map3 face acelasi lucru ca si Map1, doar ca este o mapa diferita
...
public class Map3 {
    ...
    File xmlFile = new File("res/textures/Map/MapLayout/Map3.xml");

    int[][] idMatrix = XmlToMatrix.GetIdMatrix(xmlFile,height, width);
    public Map3(GameWindow wnd){
        this.wnd = wnd;
