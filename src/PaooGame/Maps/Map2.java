...
import java.io.File;
/// Clasa Map2 face acelasi lucru ca si Map1, doar ca este o mapa diferita
...
public class Map2 {
    ...
    File xmlFile = new File("res/textures/Map/MapLayout/Map2.xml");

    int[][] idMatrix = XmlToMatrix.GetIdMatrix(xmlFile,height,width);
    public Map2(GameWindow wnd){
        this.wnd = wnd;
